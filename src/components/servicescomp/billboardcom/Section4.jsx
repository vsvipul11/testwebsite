    ...
    >
      <div className="py-4 text-white">
        ...
        <p className="text-m lg:text-l lg:w-[80%]">
          ...
          display three-dimensional elements to the naked eye. No need for 3D
          glasses or any other aid. This is what makes them stand out and appear
          as if the 3D content is really a part of the viewer's actual reality,
          happening right there in real-time. Result: Your advertisement makes a
          huge impact, bigger than any other marketing campaign, grabbing
          attention and engaging users.
        </p>
      </div>
      {/* --------------------box section ------------------------------------------ */}
